...
public class claveuser_tqll extends AppCompatActivity {
    TextView usuario, carga;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_claveuser_tqll);
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if (valido == "true"){
                                            ...
                                            Intent intent = new Intent(getApplicationContext(), SeleccionaProductosTqll.class);
                                            intent.putExtra("car",posicion);
                                            intent.putExtra("user",idusuario);
                                            startActivity(intent);
                                        }else{
                                            //Si no es valido se envia mensaje
                                            Toast.makeText(getApplicationContext(),"La contraseña de usuario es incorecta",Toast.LENGTH_SHORT).show();
                                        }
