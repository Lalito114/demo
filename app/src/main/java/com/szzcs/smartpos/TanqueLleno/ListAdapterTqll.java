...
public class ListAdapterTqll  extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] ID;
    private final String[] NombreProducto;


    public ListAdapterTqll(SeleccionaProductosTqll context, List<String> ID, List<String> NombreProducto) {
