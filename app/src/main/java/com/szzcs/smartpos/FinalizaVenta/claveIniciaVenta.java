...
public class claveIniciaVenta extends BaseActivity implements FingerprintListener, View.OnClickListener {
    //datos para huella
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clave_inicia_venta);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        btnhuella = findViewById(R.id.btnhuella);
        btnhuella.setOnClickListener(claveIniciaVenta.this);
