...
public class SubOfiEfectivale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_ofi_efectivale);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                try {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SubOfiEfectivale.this);
                    ...
                    builder.setView(input)
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if (result > 1000) {
                                        Toast.makeText(SubOfiEfectivale.this, "No puedes superar el valor de 1 Fajilla", Toast.LENGTH_SHORT).show();
                                    } else {
                                        maintitle.set(position, denomi);
                                        total.set(position, String.valueOf(result));
                                        prueba2.add(result);
                                        ListAdapterBilletes adapter = new ListAdapterBilletes(SubOfiEfectivale.this, maintitle, subtitle, total);
                                        mListView.setAdapter(adapter);
                                    }
                                }
                            })
