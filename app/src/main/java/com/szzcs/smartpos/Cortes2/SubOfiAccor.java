...
public class SubOfiAccor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_ofi_accor);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                try {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SubOfiAccor.this);
                    ...
                    builder.setView(input)
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if (result > 1000) {
                                        Toast.makeText(SubOfiAccor.this, "No puedes superar el valor de 1 Fajilla", Toast.LENGTH_SHORT).show();
                                    } else {
                                        maintitle.set(position, denomi);
                                        total.set(position, String.valueOf(result));
                                        prueba2.add(result);
                                        ListAdapterBilletes adapter = new ListAdapterBilletes(SubOfiAccor.this, maintitle, subtitle, total);
                                        mListView.setAdapter(adapter);
                                    }
                                }
                            })
