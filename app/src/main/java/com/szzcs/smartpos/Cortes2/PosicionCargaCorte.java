...
import com.szzcs.smartpos.Productos.claveUsuarioProducto;
...
public class PosicionCargaCorte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posicion_carga_corte);
