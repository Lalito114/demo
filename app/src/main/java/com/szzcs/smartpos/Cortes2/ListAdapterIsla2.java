...
import com.szzcs.smartpos.Cortes.islas1;
import com.szzcs.smartpos.R;

import java.util.List;

public class ListAdapterIsla2 extends ArrayAdapter<String> {
    ...
    public ListAdapterIsla2(Islas2 context, List<String> maintitle, List<String> subtitle, List<Integer> imgid) {
