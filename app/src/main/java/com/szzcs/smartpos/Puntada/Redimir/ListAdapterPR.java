...
public class ListAdapterPR  extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] maintitle;
    private final String[] subtitle;
    private final Integer[] imgid;

    public ListAdapterPR(PosicionRedimir context, List<String> maintitle, List<String> subtitle, List<Integer> imgid) {
