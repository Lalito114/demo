...
class ListAdapterRegistrar extends ArrayAdapter<String> {
    ...
    public ListAdapterRegistrar(PosicionCargasPuntada context, List<String> maintitle, List<String> subtitle, List<Integer> imgid) {
