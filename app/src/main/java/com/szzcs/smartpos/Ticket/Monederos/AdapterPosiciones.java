...
public class AdapterPosiciones extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] maintitle;
    private final String[] subtitle;
    private final Integer[] imgid;

    public AdapterPosiciones(posicionesDespachador context, List<String> maintitle, List<String> subtitle, List<Integer> imgid) {
