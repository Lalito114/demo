...
public class claveUsuarioPendientes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clave_usuario_pendientes);
    ...
    private void paginaSiguiente(){
        ...
        ImageView VistaSiguiente = (ImageView) findViewById(R.id.imgPendientes);
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (valido == "true"){
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), com.szzcs.smartpos.Pendientes.TicketsPendientes.class);
